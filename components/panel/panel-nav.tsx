  ...
  if (name === "blog")
    return (
      <svg {...common} aria-hidden="true">
        ...
        />
        <path strokeLinecap="round" d="M8 10h6M8 14h6M8 18h4M15 3v4h4" />
      </svg>
    );
  if (name === "shop")
    return (
      <svg {...common} aria-hidden="true">
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M4 9h16l-1 12H5L4 9ZM8 9V7a4 4 0 0 1 8 0v2"
        />
      </svg>
    );
  if (name === "categories")
    ...
    return (
      <svg {...common} aria-hidden="true">
        ...
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="m5 18 4.5-4 3 2.5 2.5-2 4 3.5"
        />
      </svg>
    );
  if (name === "exams")
    return (
      <svg {...common} aria-hidden="true">
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M7 4.5h10a2 2 0 0 1 2 2V21H5V6.5a2 2 0 0 1 2-2Z"
        />
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M9 4.5V3h6v1.5M8.5 10l1.5 1.5 2.5-3M8.5 16h7"
        />
      </svg>
    );
  if (name === "attendance")
    return (
      <svg {...common} aria-hidden="true">
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M6 3.5h12a2 2 0 0 1 2 2v15H4v-15a2 2 0 0 1 2-2Z"
        />
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="m7.5 9 1.7 1.7 3.3-3.4M7.5 15h9M15 8h1.5"
        />
      </svg>
    );
  if (name === "terms")
    return (
      <svg {...common} aria-hidden="true">
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M4 5.5h16v14H4zM8 3v5M16 3v5M4 9.5h16"
        />
        <path strokeLinecap="round" d="M8 13h3M8 16h6" />
      </svg>
    );
  if (name === "levels")
    return (
  ...
  if (name === "schedule")
    return (
      <svg {...common} aria-hidden="true">
        ...
        <path
          strokeLinecap="round"
          d="M7.5 3v4M16.5 3v4M3.5 9.5h17M8 13h3M13.5 13H16M8 17h3"
        />
      </svg>
    );
  if (name === "comments")
  ...
  if (name === "about")
    return (
      <svg {...common} aria-hidden="true">
        ...
        <path strokeLinecap="round" d="M12 11v6M12 7.5v.25" />
      </svg>
    );
  if (name === "users")
    return (
      <svg {...common} aria-hidden="true">
        ...
        <path
          strokeLinecap="round"
          d="M3.5 20a5.5 5.5 0 0 1 11 0M16 5.5a3 3 0 0 1 0 5.8M16.5 15a5 5 0 0 1 4 5"
        />
      </svg>
    );
  if (name === "studentInfo")
    return (
      <svg {...common} aria-hidden="true">
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M5 3.5h14v17H5zM8 8h8M8 12h8M8 16h5"
        />
      </svg>
    );
  if (name === "teacherProfile")
    return (
      <svg {...common} aria-hidden="true">
        ...
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M5 20a7 7 0 0 1 14 0M4 4h3M17 4h3M18.5 2.5v3"
        />
      </svg>
    );
  if (name === "honors")
    return (
      <svg {...common} aria-hidden="true">
        ...
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="m8.5 13-1 8 4.5-2.5 4.5 2.5-1-8M12 6.5v5M9.5 9H14.5"
        />
      </svg>
    );
  return (
...
export function PanelNav({
  ...
  const directLinks: NavItem[] =
    user.role === "student"
      ? [
          {
            href: "/panel/student/schedule",
            label: dictionary.nav.schedule,
            icon: "schedule",
          },
          {
            href: "/panel/student/information",
            label: dictionary.nav.studentInformation,
            icon: "studentInfo",
          },
        ]
      : user.role === "teacher"
        ? [
            {
              ...
              label: dictionary.nav.attendance,
              icon: "attendance",
            },
            {
              href: "/panel/teacher/terms",
              label: dictionary.nav.terms,
              icon: "terms",
            },
            {
              href: "/panel/teacher/schedule",
              label: dictionary.nav.schedule,
              icon: "schedule",
            },
            {
              href: "/panel/teacher/profile",
              label: dictionary.nav.teacherProfile,
              icon: "teacherProfile",
            },
          ]
        : [];
  ...
  if (user.role === "student")
    directLinks.unshift(
      {
        href: "/panel/student/terms",
        label: fa ? "کلاس‌ها و ثبت‌نام" : "Classes & enrollment",
        icon: "terms",
      },
      {
        href: "/panel/student/attendance",
        label: fa ? "حضور و نمره‌ها" : "Attendance & grades",
        icon: "attendance",
      },
      {
        href: "/panel/student/exams",
        label: fa ? "آزمون‌ها" : "Exams",
        icon: "exams",
      },
      {
        href: "/panel/student/learning/homework",
        label: fa ? "تکالیف" : "Homework",
        icon: "blog",
      },
      {
        href: "/panel/student/learning/recordings",
        label: fa ? "جلسات ضبط‌شده" : "Recorded lessons",
        icon: "media",
      },
      {
        href: "/panel/student/previous-courses",
        label: fa ? "دوره‌های گذشته" : "Previous courses",
        icon: "levels",
      },
    );
  if (user.role === "teacher")
    directLinks.push(
      {
        href: "/panel/teacher/students",
        label: fa ? "دانش پژوهان" : "Students",
        icon: "users",
      },
      {
        href: "/panel/teacher/absences",
        label: fa ? "غیبت‌ها" : "Absences",
        icon: "attendance",
      },
      {
        href: "/panel/teacher/learning/homework",
        label: fa ? "تکالیف" : "Homework",
        icon: "blog",
      },
      {
        href: "/panel/teacher/learning/recordings",
        label: fa ? "جلسات ضبط‌شده" : "Recorded lessons",
        icon: "media",
      },
      {
        href: "/panel/teacher/learning/reports",
        label: fa ? "گزارش‌های آموزشی" : "Teaching reports",
        icon: "blog",
      },
    );
      ...
      ? [
          {
            ...
            items: [
              ...
              {
                href: "/panel/admin/terms",
                label: dictionary.nav.terms,
                icon: "terms",
              },
              {
                href: "/panel/admin/term-levels",
                label: dictionary.nav.termLevels,
                icon: "levels",
              },
              {
                href: "/panel/admin/exams",
                label: dictionary.nav.exams,
                icon: "exams",
              },
              {
                href: "/panel/admin/exam-assignments",
                label: fa
                  ? "تخصیص و نتایج آزمون"
              ...
              },
              {
                ...
                label: fa ? "صفحه‌های دوره" : "Course pages",
                icon: "blog",
              },
              {
                href: "/panel/admin/learning/homework",
                label: fa ? "تکالیف" : "Homework",
                icon: "blog",
              },
              {
                href: "/panel/admin/learning/recordings",
                label: fa ? "جلسات ضبط‌شده" : "Recorded lessons",
                icon: "media",
              },
              {
                href: "/panel/admin/learning/reports",
                label: fa ? "گزارش‌های آموزشی" : "Teaching reports",
                icon: "blog",
              },
              {
                href: "/panel/admin/absences",
                label: fa ? "غیبت‌ها" : "Absences",
                icon: "attendance",
              },
            ],
            ...
            items: [
              {
                ...
                label: dictionary.nav.students,
                icon: "users",
              },
              {
                href: "/panel/admin/teachers",
                label: dictionary.nav.teachers,
                icon: "users",
              },
              {
                href: "/panel/admin/members",
                label: dictionary.nav.members,
                icon: "users",
              },
              {
                href: "/panel/admin/admins",
                label: dictionary.nav.admins,
                icon: "users",
              },
            ],
          },
          {
            ...
            items: [
              ...
              {
                href: "/panel/admin/honors",
                label: dictionary.nav.honors,
                icon: "honors",
              },
              {
                href: "/panel/admin/media",
                label: dictionary.nav.media,
                icon: "media",
              },
              {
                href: "/panel/admin/comments",
                label: dictionary.nav.comments,
                icon: "comments",
              },
              {
                href: "/panel/admin/about",
                label: dictionary.nav.about,
                icon: "about",
              },
              {
                href: "/panel/admin/resources/faqs",
                label: fa ? "پرسش‌های متداول" : "FAQs",
                icon: "about",
              },
              {
                href: "/panel/admin/resources/guides",
                label: fa ? "راهنمای پنل" : "Panel guides",
                icon: "blog",
              },
              {
                href: "/panel/admin/resources/requirements",
                label: fa ? "پیش‌نیازهای یادگیری" : "Learning requirements",
                icon: "levels",
              },
              {
                href: "/panel/admin/notifications",
                label: fa ? "مدیریت اعلان‌ها" : "Manage notifications",
                icon: "about",
              },
              {
                href: "/panel/admin/departments",
                label: fa ? "دپارتمان‌های پشتیبانی" : "Support departments",
                icon: "comments",
              },
            ],
          },
          {
            ...
            items: [
              ...
              {
                href: "/panel/admin/product-categories",
  ...
  const isActive = (href: string) =>
    pathname === href ||
    (href !== roleHome[user.role] && pathname.startsWith(`${href}/`));
  ...
  return (
    <aside className="relative z-50 flex flex-col border-b border-zinc-200 bg-white/95 px-4 py-4 backdrop-blur-xl lg:sticky lg:top-0 lg:h-dvh lg:w-72 lg:shrink-0 lg:overflow-hidden lg:border-b-0 lg:border-e lg:px-4 lg:py-5 dark:border-zinc-800 dark:bg-zinc-950/95">
      <div className="flex shrink-0 items-center justify-between gap-4 border-b border-zinc-200 pb-4 dark:border-zinc-800">
        <Link
          href={roleHome[user.role]}
          aria-label={locale === "fa" ? "پنل کاکتوس" : "Cactus panel"}
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/panel/profile"
            className="rounded-full outline-none focus-visible:ring-2 focus-visible:ring-emerald-600 lg:hidden"
      ...
      <div className="py-3 lg:min-h-0 lg:flex-1 lg:py-4">
        ...
        >
          <span className="grid size-9 shrink-0 place-items-center rounded-xl bg-emerald-100 text-emerald-700 dark:bg-emerald-950 dark:text-emerald-300">
            <Icon name={activeItem.icon} className="size-4.5" />
          </span>
          <span className="min-w-0 flex-1">
            <span className="block text-[11px] font-medium text-zinc-500 dark:text-zinc-400">
              {dictionary.nav.currentSection}
            </span>
            <span className="mt-0.5 block truncate text-sm font-semibold text-zinc-950 dark:text-zinc-50">
              {activeItem.label}
            </span>
          </span>
          <span className="grid size-9 shrink-0 place-items-center rounded-xl text-zinc-500 dark:text-zinc-400">
        ...
        >
          <p className="mb-2 px-3 pt-1 text-[11px] font-bold uppercase tracking-wider text-zinc-400">
          ...
          <nav aria-label={dictionary.nav.workspace} className="space-y-1">
            ...
            >
              <span className="shrink-0 text-zinc-400 transition group-hover:text-zinc-700 group-aria-[current=page]:text-emerald-700 dark:text-zinc-500 dark:group-hover:text-zinc-200 dark:group-aria-[current=page]:text-emerald-300">
                <Icon name={overview.icon} className="size-4.5" />
              </span>
          ...
          {groups.length ? (
            <p className="mb-1 mt-4 px-3 text-[11px] font-bold uppercase tracking-wider text-zinc-400">
              {dictionary.nav.management}
            </p>
          ) : null}
            ...
            {groups.map((group) => {
              ...
              return (
                <div key={group.id}>
                  ...
                  >
                    <span
                      className={`shrink-0 ${groupActive ? "text-emerald-600 dark:text-emerald-400" : "text-zinc-400 dark:text-zinc-500"}`}
                    >
                  ...
                  {open ? (
                    <nav
                      ...
                      className="ms-5 mt-0.5 space-y-0.5 border-s border-zinc-200 ps-3 dark:border-zinc-800"
                    >
      ...
      <div className="flex shrink-0 items-center justify-between border-t border-zinc-200 pt-3 text-xs lg:hidden dark:border-zinc-800">
        <a
          ...
          aria-label={dictionary.nav.publicSiteNewTabLabel}
          className="rounded-lg px-1 py-1 text-zinc-500 outline-none transition hover:text-emerald-700 focus-visible:ring-2 focus-visible:ring-emerald-600 dark:text-zinc-400 dark:hover:text-emerald-300"
        >
          {dictionary.nav.publicSite}
        </a>
        <form action={logout}>
          <button
            type="submit"
            className="cursor-pointer rounded-lg px-1 py-1 text-red-600 outline-none transition hover:text-red-700 focus-visible:ring-2 focus-visible:ring-red-500 dark:text-red-400"
          >
      ...
      <div className="hidden shrink-0 border-t border-zinc-200 pt-4 lg:block dark:border-zinc-800">
        <Link
          href="/panel/profile"
          className="group flex items-center gap-3 rounded-2xl border border-transparent bg-zinc-50 p-3 outline-none transition hover:border-emerald-200 hover:bg-emerald-50 focus-visible:ring-2 focus-visible:ring-emerald-600 dark:bg-zinc-900 dark:hover:border-emerald-900 dark:hover:bg-emerald-950/50"
        >
          <UserAvatar
            name={userName}
            src={user.avatarUrl}
            className="size-11 ring-2 ring-white dark:ring-zinc-800"
          />
          <span className="min-w-0 flex-1">
            ...
            <span
              className="nums-en mt-0.5 block truncate text-xs text-zinc-500"
              dir="ltr"
            >
              {user.mobile}
            </span>
          ...
          <svg
            viewBox="0 0 20 20"
            aria-hidden="true"
            className="size-4 shrink-0 text-zinc-400 transition group-hover:text-emerald-600 rtl:rotate-180"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.8"
          >
