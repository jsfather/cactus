...
import { DeleteReport } from '@/components/ui/teacher/reports/buttons';
import { Report, getReports } from '@/lib/api/panel/teacher/reports';
import { useEffect, useState } from 'react';
import { toast } from 'react-hot-toast';

export default function ReportsTable({}: { query: string; currentPage: number }) {
