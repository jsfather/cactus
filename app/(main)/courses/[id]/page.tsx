...
import { Clock, Calendar, Users, BookOpen, GraduationCap, BarChart } from 'lucide-react';
      ...
      <article className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            ...
            {/* Course Meta */}
            <div className="mb-8 grid grid-cols-2 gap-4 rounded-2xl bg-gray-50 p-6 dark:bg-gray-800 md:grid-cols-3">
              <div className="flex items-center gap-3">
                <BarChart className="h-6 w-6 text-primary-600" />
                <div>
                  <p className="text-sm text-gray-600 dark:text-gray-400">سطح دوره</p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-gray-600 dark:text-gray-400">مدت دوره</p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-gray-600 dark:text-gray-400">تعداد دانشجو</p>
            ...
            <div className="prose prose-lg mb-8 max-w-none dark:prose-invert">
              <h2>توضیحات دوره</h2>
              <p>
                در این دوره جامع، شما با مفاهیم پایه و پیشرفته برنامه‌نویسی پایتون آشنا خواهید شد.
                از صفر تا صد پایتون را به همراه کاربردهای عملی آن خواهید آموخت.
              </p>
            ...
            <div className="mb-12 rounded-2xl bg-gray-50 p-6 dark:bg-gray-800">
              ...
              <div className="flex items-start gap-4">
                ...
                />
                <div>
                  <h3 className="mb-2 text-xl font-bold">{courseData.instructor.name}</h3>
          ...
          <aside className="lg:sticky lg:top-24 lg:h-fit">
            <div className="rounded-2xl bg-gray-50 p-6 dark:bg-gray-800">
              <div className="mb-6 text-center">
                <p className="mb-2 text-sm text-gray-600 dark:text-gray-400">قیمت دوره</p>
                <p className="text-3xl font-bold text-primary-600">{courseData.price}</p>
              </div>
