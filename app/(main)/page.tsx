    ...
    >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 text-center">
            <Button asChild className="px-8 text-base">
              <Link href="/shop">{t.home.shop.viewAllProducts}</Link>
            </Button>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="mb-16 flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            ...
            <Button asChild variant="outline" className="px-6">
              <Link href="/teachers">{t.home.teachers.viewAllTeachers}</Link>
            </Button>
          </div>
      ...
      <section id="courses" className="py-20 dark:bg-gray-900">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 text-center">
            <Button asChild className="px-8 text-base">
              <Link href="/courses">{t.home.courses.viewAllCourses}</Link>
            </Button>
          </div>
        </div>
      </section>
      ...
      <section id="blog" className="bg-gray-50 py-24 dark:bg-gray-900">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 text-center">
            <Button asChild className="px-8 text-base">
              <Link href="/blog">{t.home.blog.viewAllArticles}</Link>
            </Button>
          </div>
        </div>
      </section>
