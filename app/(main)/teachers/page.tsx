      ...
      <section className="bg-gradient-to-b from-gray-50 to-white py-12 dark:from-gray-800 dark:to-gray-900">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl text-center">
            ...
            >
              <h1 className="mb-4 text-4xl font-bold">مربیان برتر آکادمی کاکتوس</h1>
              <p className="text-gray-600 dark:text-gray-300">
                با بهترین اساتید و متخصصان در حوزه‌های مختلف فناوری آشنا شوید. مربیان ما با
                تجربه عملی و دانش تخصصی، مسیر یادگیری شما را هموار می‌کنند.
              </p>
            </motion.div>
          </div>
        </div>
