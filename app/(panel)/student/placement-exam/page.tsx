      ...
      <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        ...
        <div className="text-center py-8">
          ...
          <p className="mb-6 text-gray-600 dark:text-gray-400">
            برای شروع آزمون تعیین سطح، شناسه آزمون را وارد کنید یا از لینک ارائه شده استفاده کنید.
          </p>
          ...
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <input
              ...
              className="w-full max-w-xs rounded-lg border border-gray-300 px-4 py-2 text-center focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-200 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:focus:border-primary-500"
              onKeyPress={(e) => {
                if (e.key === 'Enter') {
